...
using Covid19KeralaApi.Models.TokenAuth;
...
{
    public abstract class Covid19KeralaApiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Covid19KeralaApiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Covid19KeralaApiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Covid19KeralaApiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Covid19KeralaApiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Covid19KeralaApiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Covid19KeralaApiDbContext, Task<T>> func)
        {
            T result;
