...
namespace Covid19KeralaApi.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Covid19KeralaApiConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Covid19KeralaApiDbContext context)
        {
            _context = context;
        }
